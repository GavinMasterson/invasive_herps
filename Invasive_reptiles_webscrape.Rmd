...
### NEED TO FILL BASED ON THE CLASS SO THAT AMPHIBIAN AND REPTILE FAMILIES ARE DISTINGUISHABLE - ADD CLASS TO THE inv_family TIBBLE.
                
ggplotly(invfam_plot, tooltip = "text")
```

The graph above is simple enough to interpret but needs to have the information about each family's species tally incorporated. Let's do that now. 
